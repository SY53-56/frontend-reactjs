...
export default function login() {
  return (
   ...
   <form className='w-96 h-auto px-5 py-5 flex  flex-col gap-4 border rounded-lg shadow-2xl' action="">
    ...
    <p className='text-[18px]'>if you have already accounts <Link className='text-emerald-600' to="/signup">Signup</Link></p>
   </form> 
    </div>
  )
}
